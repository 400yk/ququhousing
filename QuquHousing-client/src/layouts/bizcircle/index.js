...
import Projects from "layouts/bizcircle/components/Projects";
import OrdersOverview from "layouts/bizcircle/components/OrdersOverview";
...
const Bizcircle = () => {
  ...
  const [toggleTotalPrice, setToggleTotalPrice] = useState(false);
  ...
  useEffect(() => {
    ...
    const fetchCompounds = async () => {
      try {
        const response = await axiosPrivate.post('/bizcircle', {
        ...
        <form onSubmit={handleSubmit}>
          <Grid container spacing={3}>
            ...
            <Grid item xs={12} md={6} lg={2}>
              ...
              />
              <FormControlLabel
                control={<Checkbox checked={toggleTotalPrice} onChange={() => setToggleTotalPrice(!toggleTotalPrice)} />}
                label="显示总价"
              />
            </Grid>
            <Grid item xs={12} md={6} lg={2}>
          ...
          <Grid container spacing={3}>
            <Grid item xs={12} md={6} lg={8}>
              <Projects
                ...
                showTotalPrice={toggleTotalPrice}
